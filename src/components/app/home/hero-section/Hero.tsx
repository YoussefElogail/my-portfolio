...
const Hero = () => {
  return (
    <section className="section-container min-h-[calc(100vh-100px)] flex flex-col-reverse sm:flex-row gap-2 items-center text-lightn justify-between overflow-hidden pt-6">
      {/* Left Content */}
